...
**Status**: planned — forged from CTO research 0217b270 (2026-08-27); implementation dispatch gated on PGC waves + first post-PGC AC checkpoint; prerequisite unit SGR-U0 (imported generic entry instantiation — the hard gate) dispatched in parallel 2026-08-27 per operator order (handle 249eba5e, packet sgr-u0)
**Created**: 2026-08-27
