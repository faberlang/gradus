...
**Status**: lowered 2026-08-13 by planner-26 (task `1b07f5c0` / handle `1b07f5c0`) — **READY at the spec level; dispatch-gated on MODEL-01 (GGUF-M1) landing and the LIB-03 (GGUF-A3) BF16/Q5_K codecs**. Planning artifact only: no product code is written by this lowering.
