...
**Status**: SUPERSEDED 2026-08-22 by [`pml5-gguf-m2-moe-router-delivery-2026-08-22.md`](pml5-gguf-m2-moe-router-delivery-2026-08-22.md) (MODEL-01 merged; the Latin surface spellings were retracted by the live dialect; `silu` landed on main). Successor implementation note: MODEL-02-U3–U6 landed on gradus main at `b1ccfc8`; U7's real-artifact adapter/receipt and U8's documentation closeout remain successor work. Historical: lowered 2026-08-13 by planner-26 (task `1b07f5c0` / handle `1b07f5c0`) — **READY at the spec level; dispatch-gated on MODEL-01 (GGUF-M1) landing and the LIB-03 (GGUF-A3) BF16/Q5_K codecs**. Planning artifact only: no product code is written by this lowering.
