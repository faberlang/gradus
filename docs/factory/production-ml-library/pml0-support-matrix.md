...
| `legal fixture ref` | `fixtures/safetensors/smollm2-360m-scaled-row.safetensors` — SHA-256 `992426b54e8d7a1b7e24e4167a92a5e630bb79ef7e89efdd5fd2cb2b29d0a0bc` (1512 bytes); local synthetic fixture, no acquisition or redistribution claim |
| `oracle ref` | the PML2-U2 row-oracle (`fixtures/safetensors/safetensors-row-oracle.md`): pinned header/data facts (JSON header length N 832, 672-byte data region starting at byte 840, deterministic data pattern); the proba embeds the same byte sequence and verifies the capsule digest via `capsula.verifica_contra` (digest value host-computed per the capsule boundary) |
...
| `legal fixture ref` | no new fixture — consumes the admitted PML2 model-file fixtures (`fixtures/safetensors/smollm2-360m-scaled-row.safetensors` SHA-256 `992426b54e8d7a1b7e24e4167a92a5e630bb79ef7e89efdd5fd2cb2b29d0a0bc`; `fixtures/gguf/smollm2-360m-scaled-row.gguf` SHA-256 `d89c9ef917158bfb5600f417020479499c6c042f728e9a29c8457a6b1a8f0974`) + the pinned tokenizer probes (P1–P11, `fixtures/tokenizer/tokenizer-identity-oracle.md`) |
...
| Runtime identity claim (bare forward ≡ generated companion, executed) | R9/R11 — the train/optimize proba suites execute 90/90 on FMIR, but this broader bare-forward ≡ generated-companion identity has no runtime receipt; it remains deferred to the named runtime-evidence gate (CTO8-1), recorded and not admitted. |
...
| **Executed-identity row for any admitted row** (executed forward≡companion identity, executed convergence values, or executed tokens) | R9/R11 — train/optimize proba executes 90/90 on FMIR, but rows without an executed identity receipt remain structural; executed forward≡companion and token identity remain the auditor-owned runtime-evidence gate (CTO8-1, named open clause). Every row's structural-tier note marks the boundary. |
...
grep -c '992426b54e8d7a1b7e24e4167a92a5e630bb79ef7e89efdd5fd2cb2b29d0a0bc' docs/factory/production-ml-library/pml0-support-matrix.md   # >= 1
