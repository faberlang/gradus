...
the **executed probe tier** (row 9, LIB-02-U4-1/U4-3), and one MODEL-01
qwen35moe architecture admission row at the **structural tier** (row 10,
facts only). Every row is
...
### Row 10 — MODEL-01 qwen35moe architecture admission row (structural tier, facts only)
...
**Structural tier (recorded, not claimed).** Row 10 records architecture +
...
# 1. Ten admitted rows (2 PML2 format, 2 PML3 architecture, 1 PML4
...
#    1 MODEL-01 qwen35moe architecture admission),
