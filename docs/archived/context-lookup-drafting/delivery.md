...
| write_scope | `src/receipt.fab` (additive `1.1.0` fields/constructors/wire); `src/receipt.proba`; `docs/archived/context-lookup-drafting/receipts/` (new, checked-in JSON rows for both regimes) |
